...
public class ClientContext {
	...
	private TokenGenerator initTokenGenerator(){
		TokenGenerator token = new TokenGenerator(context);
		return token;
	}
	...
	public ResponseWrapper getToken(){
		...
		if(redisUtil.exists(Constant.TOKEN)){
			...
			responseWrapper.setResponseStatus(200);
			responseWrapper.setResponseBody(json.get("body"));
		}
